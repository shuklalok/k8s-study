...
- **[Topic 0 — Docker, Images & Containers](00-docker-images-containers.md)**
...
- **[Topic 1 — Basic Concepts of K8s](01-basic-concepts.md)**
...
- **[Topic 2 — Helm Charts & Deployment](02-helm-charts.md)**
...
- **[Topic 3 — Management of Pods & Services](03-pods-and-services.md)**
...
- **[Topic 4 — K8s Networking / Firewall Policies](04-networking.md)**
...
- **[Topic 5 — Secrets & Config](05-secrets-config.md)**
  - 5.1 — ConfigMaps (+ Q&A)
  - 5.2 — Secrets
  - 5.3 — Best Practices & Production Tips
  - Q&A — Topic 5 (combined)

- **[Topic 6 — High Availability](06-high-availability.md)**
